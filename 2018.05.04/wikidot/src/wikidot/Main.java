...
ImageIcon(this.getClass().getResource("imagens/metal.png")));

menuItemEstilo[1] = new JRadioButtonMenuItem("Linux");
menuItemEstilo[1].setIcon(new
ImageIcon(this.getClass().getResource("imagens/linux.png"))); // LINUX.PNG

menuItemEstilo[2] = new JRadioButtonMenuItem("Windows");
menuItemEstilo[2].setIcon(new
ImageIcon(this.getClass().getResource("imagens/windows.png"))); // WINDOWS PNG
